...
import { CreateListDto, GetTasksDto } from 'shared';
...
export class ListsController {
    ...
    @Patch(":id/showDoneItems") 
    updateShowDoneItems(@Param("id", ParseIntPipe) id: number, @GetUser() user: User, @Body("showDoneItems") showDoneItems: boolean ): Promise<List> {
        return this.listsService.updateList({ id, showDoneItems }, user);
    }
